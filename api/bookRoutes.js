const{ createBook, getBooks, updateBook, deleteBook, getBookPageCount }  = require('../lib/neoCrud/book');
    ...
    switch (method) {
        ...
        case 'GET':
            try {
                ...
                const books = await getBooks({ name, author, isbn, outOfStock: outOfStock === 'true', limit: parseInt(limit), skip: parseInt(skip) });
